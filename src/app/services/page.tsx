          ...
          <div className="row">
            ...
            <div className="service-item padd-15">
              <div className="service-item-inner">
                ...
                <p>
                  Design and develop your website on WordPress with a
                  responsive, SEO-ready theme customized to your brand.
                </p>
              </div>
            </div>
            {/* Service Item 3 End */}
            ...
            <div className="service-item padd-15">
              <div className="service-item-inner">
                ...
                <p>
                  Complete front-end and back-end development for fast,
            ...
            <div className="service-item padd-15">
              <div className="service-item-inner">
                ...
                <p>
                  Professional full-stack web development with optimized
                  front-end, secure back-end, and high-performance websites.
                </p>
              </div>
            </div>
            {/* Service Item 6 End */}
